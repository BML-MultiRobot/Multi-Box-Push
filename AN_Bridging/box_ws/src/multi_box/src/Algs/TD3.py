...
'''Twin-delayed DDPG to curb Q value overestimation with clipped double Q-learning, Q value smoothing using noise 
and delayed policy updates for stability'''
...
class Twin_DDPG(Agent):
    def __init__(self, params, name, task):
        ...
        self.exp        = None  # Replace this if plan on using
