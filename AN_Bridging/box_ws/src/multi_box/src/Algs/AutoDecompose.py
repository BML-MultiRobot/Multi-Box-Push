...
""" Novel (-ish) Hierarchical decomposition for inverse reinforcement learning approach. 
RNN to search for non-linearities along given trajectory. IRL not implemented but decomposition is."""
